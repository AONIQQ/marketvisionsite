        ...
        <main className="flex-grow">
          <section className="pt-6 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white">
            <div className="container mx-auto text-center">
              ...
              <div className="max-w-4xl mx-auto mb-12 w-full px-4 sm:px-6 lg:px-8">
                {/* Updated Calendly embed code */}
                <div className="calendly-inline-widget" 
                     data-url="https://calendly.com/stevensilverglade/call?hide_gdpr_banner=1&primary_color=472484" 
